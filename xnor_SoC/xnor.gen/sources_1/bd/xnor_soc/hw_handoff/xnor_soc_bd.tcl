...
################################################################
# This is a generated script based on design: xnor_soc
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: xnor_hw_0, and set properties
  set block_name xnor_hw
  set block_cell_name xnor_hw_0
  if { [catch {set xnor_hw_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net a_0_1 [get_bd_ports a] [get_bd_pins xnor_hw_0/a]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports led] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net b_0_1 [get_bd_ports b] [get_bd_pins xnor_hw_0/b]
  ...
  connect_bd_net -net xnor_hw_0_y [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins xnor_hw_0/y]
