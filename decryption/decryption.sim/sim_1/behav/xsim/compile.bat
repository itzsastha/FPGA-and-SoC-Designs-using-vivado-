...
REM
REM Generated by Vivado on Fri Jun 07 10:39:41 +0530 2024
...
echo "xvlog --incr --relax -prj decryption_vlog.prj"
call xvlog  --incr --relax -prj decryption_vlog.prj -log xvlog.log
