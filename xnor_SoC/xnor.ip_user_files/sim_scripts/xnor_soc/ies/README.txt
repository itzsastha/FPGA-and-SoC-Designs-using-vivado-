...
#
# Generated by export_simulation on Sat Jun 08 15:18:38 +0530 2024
#
################################################################################
...
'-reset_run' switch to the './xnor_soc.sh' script.

./xnor_soc.sh -reset_run
...
./xnor_soc.sh -noclean_files

For more information on the script, please type './xnor_soc.sh -help'.
